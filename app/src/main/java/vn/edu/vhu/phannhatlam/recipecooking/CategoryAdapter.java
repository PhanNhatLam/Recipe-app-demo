        ...
        private void setCategory(final String name, final int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (position != 0) {
                        Intent catogoryIntent = new Intent(itemView.getContext(), CategoryActivity.class);
                        catogoryIntent.putExtra("CategoryName", name);
                        itemView.getContext().startActivity(catogoryIntent);
                    }
                }
            });
        }
